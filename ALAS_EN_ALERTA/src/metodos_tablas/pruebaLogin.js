...
const emailDePrueba = 'andrea@gmail.com'; // Asegúrate de que este email esté en la base de datos
const contraseñaDePrueba = '2023'; // Coloca aquí la contraseña en texto claro que corresponde al usuario
